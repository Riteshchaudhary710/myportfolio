        ...
        <div style={{
          ...
          {!isMobile && (
            <div style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
              <a className="cv-btn" href={`${import.meta.env.BASE_URL}Ritesh_Chaudhary_CV.pdf`} download>
      ...
      {isMobile && (
        <div className="mobile-drawer" style={{ transform: menuOpen ? "translateX(0)" : "translateX(100%)" }}>
          ...
          <div style={{ marginTop: "auto", paddingTop: "2rem", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            <a className="cv-btn" href={`${import.meta.env.BASE_URL}Ritesh_Chaudhary_CV.pdf`} download style={{ justifyContent: "center" }}>
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                <polyline points="7 10 12 15 17 10" />
                <line x1="12" y1="15" x2="12" y2="3" />
